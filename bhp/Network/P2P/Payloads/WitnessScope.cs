...
namespace Bhp.Network.P2P.Payloads
{
    ...
    {
        /// <summary>
        /// Global allows this witness in all contexts (default Bhp2 behavior)
        ...
        /// This can be default safe choice for native BHP/GAS (previously used on Bhp 2 as "attach" mode)
        /// </summary>
        CalledByEntry = 0x01,
