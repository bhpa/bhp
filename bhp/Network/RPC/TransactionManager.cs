...
namespace Bhp.Network.RPC
{
    ...
    public class TransactionManager
    {
        ...
        /// </summary>
        /// <param name="rpc">the RPC client to call Bhp RPC API</param>
        ...
        public TransactionManager MakeTransaction(byte[] script, TransactionAttribute[] attributes = null, Cosigner[] cosigners = null, long networkFee = 0)
        {
            ...
            var gasBalance = new Brc5API(rpcClient).BalanceOf(NativeContract.GAS.Hash, sender);
        ...
        private long EstimateNetworkFee()
        {
            ...
            {
                size += 166;
                networkFee += ApplicationEngine.OpCodePrices[OpCode.PUSHBYTES64] + ApplicationEngine.OpCodePrices[OpCode.PUSHBYTES33] + InteropService.GetPrice(InteropService.Bhp_Crypto_CheckSig, null);
            }
