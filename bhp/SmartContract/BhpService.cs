...
namespace Bhp.SmartContract
{
    public class BhpService : StandardService
    {
            ...
            : base(trigger, snapshot)
        {
            ...
            Register("Bhp.Runtime.Log", Runtime_Log, 1);
            Register("Bhp.Runtime.GetTime", Runtime_GetTime, 1);
            Register("Bhp.Runtime.Serialize", Runtime_Serialize, 1);
            Register("Bhp.Runtime.Deserialize", Runtime_Deserialize, 1);
            Register("Bhp.Blockchain.GetHeight", Blockchain_GetHeight, 1);
            Register("Bhp.Blockchain.GetHeader", Blockchain_GetHeader, 100);
            ...
            Register("Bhp.Header.GetHash", Header_GetHash, 1);
            Register("Bhp.Header.GetVersion", Header_GetVersion, 1);
            Register("Bhp.Header.GetPrevHash", Header_GetPrevHash, 1);
            Register("Bhp.Header.GetMerkleRoot", Header_GetMerkleRoot, 1);
            Register("Bhp.Header.GetTimestamp", Header_GetTimestamp, 1);
            Register("Bhp.Header.GetIndex", Header_GetIndex, 1);
            Register("Bhp.Header.GetConsensusData", Header_GetConsensusData, 1);
            Register("Bhp.Header.GetNextConsensus", Header_GetNextConsensus, 1);
            Register("Bhp.Block.GetTransactionCount", Block_GetTransactionCount, 1);
            Register("Bhp.Block.GetTransactions", Block_GetTransactions, 1);
            Register("Bhp.Block.GetTransaction", Block_GetTransaction, 1);
            Register("Bhp.Transaction.GetHash", Transaction_GetHash, 1);
            Register("Bhp.Transaction.GetType", Transaction_GetType, 1);
            Register("Bhp.Transaction.GetAttributes", Transaction_GetAttributes, 1);
            Register("Bhp.Transaction.GetInputs", Transaction_GetInputs, 1);
            Register("Bhp.Transaction.GetOutputs", Transaction_GetOutputs, 1);
            Register("Bhp.Transaction.GetReferences", Transaction_GetReferences, 200);
            Register("Bhp.Transaction.GetUnspentCoins", Transaction_GetUnspentCoins, 200);
            Register("Bhp.Transaction.GetWitnesses", Transaction_GetWitnesses, 200);
            Register("Bhp.InvocationTransaction.GetScript", InvocationTransaction_GetScript, 1);
            Register("Bhp.Witness.GetVerificationScript", Witness_GetVerificationScript, 100);
            Register("Bhp.Attribute.GetUsage", Attribute_GetUsage, 1);
            Register("Bhp.Attribute.GetData", Attribute_GetData, 1);
            Register("Bhp.Input.GetHash", Input_GetHash, 1);
            Register("Bhp.Input.GetIndex", Input_GetIndex, 1);
            ...
            Register("Bhp.Asset.GetAssetId", Asset_GetAssetId, 1);
            Register("Bhp.Asset.GetAssetType", Asset_GetAssetType, 1);
            Register("Bhp.Asset.GetAmount", Asset_GetAmount, 1);
            Register("Bhp.Asset.GetAvailable", Asset_GetAvailable, 1);
            Register("Bhp.Asset.GetPrecision", Asset_GetPrecision, 1);
            Register("Bhp.Asset.GetOwner", Asset_GetOwner, 1);
            Register("Bhp.Asset.GetAdmin", Asset_GetAdmin, 1);
            Register("Bhp.Asset.GetIssuer", Asset_GetIssuer, 1);
            ...
            Register("Bhp.Storage.Delete", Storage_Delete, 100);
            Register("Bhp.Storage.Find", Storage_Find, 1);
            Register("Bhp.StorageContext.AsReadOnly", StorageContext_AsReadOnly, 1);
            Register("Bhp.Enumerator.Create", Enumerator_Create, 1);
            Register("Bhp.Enumerator.Next", Enumerator_Next, 1);
            Register("Bhp.Enumerator.Value", Enumerator_Value, 1);
            Register("Bhp.Enumerator.Concat", Enumerator_Concat, 1);
            Register("Bhp.Iterator.Create", Iterator_Create, 1);
        ...
        private bool Asset_Create(ExecutionEngine engine)
        {
            ...
            if (amount != -Fixed8.Satoshi && amount.GetData() % (long)Math.Pow(10, 8 - precision) != 0)
                return false;
            ECPoint owner = ECPoint.DecodePoint(engine.CurrentContext.EvaluationStack.Pop().GetByteArray(), ECCurve.Secp256);
